...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        createAccountButton.addTarget(self, action: #selector(didPressCreateAccountButton), for: .touchUpInside)
        privacyButton.addTarget(self, action: #selector(didPressPrivacyButton), for: .touchUpInside)
        termsButton.addTarget(self, action: #selector(didPressTermsButton), for: .touchUpInside)
    ...
    @objc private func didPressPrivacyButton() {
    ...
    @objc private func didPressTermsButton() {
    ...
    @objc private func didPressCreateAccountButton() {
